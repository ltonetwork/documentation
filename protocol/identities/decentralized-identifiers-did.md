...
{% hint style="success" %}
An anchor transaction with 0 anchors is the cheapest method to register a public key for an [implicit DID](decentralized-identifiers-did.md#implicit-identities).
{% endhint %}
