    ...
    "definition": [
        {
            ...
            "fields": [
                ...
                {
                    "$schema": "https://specs.livecontracts.io/draft-01/form/schema.json#amount",
                ...
                {
                    "$schema": "https://specs.livecontracts.io/draft-01/form/schema.json#money",
                    "label": "Amount",
                    "name": "amount"
                },
                {
                    "$schema": "https://specs.livecontracts.io/draft-01/form/schema.json#date",
                    "label": "Date",
                    "name": "date"
                },
                {
                    "$schema": "https://specs.livecontracts.io/draft-01/form/schema.json#email",
                    "label": "E-mail",
                    "name": "email"
                },
                {
                    "$schema": "https://specs.livecontracts.io/draft-01/form/schema.json#textarea",
                    "label": "Text area",
                    "name": "textarea"
                },
                {
                    "$schema": "https://specs.livecontracts.io/draft-01/form/schema.json#select",
                    "label": "Select",
                    "name": "select",
                    "options": [
                        {
                ...
                {
                    "$schema": "https://specs.livecontracts.io/draft-01/form/schema.json#group",
                    "label": "Option group",
                    "name": "option_group"
                },
                {
                ...
                {
                    "$schema": "https://specs.livecontracts.io/draft-01/form/schema.json#likert",
                    "label": "Likert",
                    "name": "likert",
                    "keys": [
                        "Do you like green?",
        ...
        },
        {
            ...
            "fields": [
                ...
                },
                {
                    ...
                    "name": "last_name"                },
                {
                    "$schema": "https://specs.livecontracts.io/draft-01/form/schema.json#expression",
                    "name": "name",
                ...
                {
                    "$schema": "https://specs.livecontracts.io/draft-01/form/schema.json#static",
                    "name": "static_data",
