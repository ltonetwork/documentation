    ...
    "definition": [
        {
            ...
            "fields": [
                ...
                {
                    "$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#amount",
                ...
                {
                    "$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#money",
                    "label": "Amount",
                    "name": "amount"
                },
                {
                    "$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#date",
                    "label": "Date",
                    "name": "date"
                },
                {
                    "$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#email",
                    "label": "E-mail",
                    "name": "email"
                },
                {
                    "$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#textarea",
                    "label": "Text area",
                    "name": "textarea"
                },
                {
                    "$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#select",
                    "label": "Select",
                    "name": "select",
                    "options": [
                        {
                ...
                {
                    "$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#group",
                    "label": "Option group",
                    "name": "option_group"
                },
                {
                    "$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#checkbox",
                    "label": "Checkbox",
                    "name": "checkbox",
                    "text": "Yes or no"
                },
                {
                    "$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#likert",
                    "label": "Likert",
                    "name": "likert",
                    "keys": [
                        "Do you like green?",
        ...
        },
        {
            ...
            "fields": [
                ...
                },
                {
                    ...
                    "name": "last_name"                },
                {
                    "$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#expression",
                    "name": "name",
                ...
                {
                    "$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#static",
                    "name": "static_data",
