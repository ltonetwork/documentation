    ...
    "definition": [
        {
            ...
            "fields": [
                {
                    "$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#text",
                    "label": "Name",
                    "name": "name"
                },
                {
                    "$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#password",
                    "label": "Password",
                    "name": "password"
                }
            ]
...
A URI as a globally unique identifier for the form. This is typically an [LTRI](../ltri/README.md) using a random
UUID-4; `lt:/forms/<uuid-4>`.
...
You may use a dot to group data \(eg `client.name`\). An object is automatically created in this case. This can be used
in addition or instead of `group` in a step.
...
For a text field use `"$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#text"`.
...
For a password field use `"$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#password"`.
...
For a number field use `"$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#number"`.
...
For an amount field use `"$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#amount"`.
...
_If you need to choose the currency per field, use the _[_amount field_](#amount-schema)_ instead._

#### $schema

For a money field use `"$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#money"`.
...
For a date field use `"$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#date"`.
...
For an email field use `"$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#email"`.
...
For a textarea field use `"$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#textarea"`.
...
For a select field use `"$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#select"`.
...
For a checkbox / radio button group use `"$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#select-group"`.
...
For a checkbox use `"$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#checkbox"`.
...
For a likert use `"$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#likert"`.
...
An expression is not rendered as a field, instead the expression is calculated in the background. It typically refers to
other variables in the form.

#### $schema

For an expression use `"$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#expression"`.
...
For static HTML use `"$schema": "http://specs.livecontracts.io/draft-01/form/schema.json#static"`.
