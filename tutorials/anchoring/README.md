...
To anchor on LTO mainnet, [install your own anchoring node](broken-reference) using docker. Submitting anchoring transactions on mainnet requires a transaction fee.&#x20;
