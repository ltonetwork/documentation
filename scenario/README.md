...
[JSON Schema](https://specs.livecontracts.io/v0.1.0/scenario/schema.json) | [changelog](changelog.md)
...
```json
{
  ...
  "assets": {
    ...
    "quotation": { "$ref": "https://specs.livecontracts.io/v0.1.0/document/schema.json#" }
  },
  "definitions": {
    "request_form": {
...
`https://specs.livecontracts.io/v0.1.0/scenario/schema.json#`
...
```json
{
  "actors": {
    ...
    "employee": {
      "$ref": "https://specs.livecontracts.io/v0.1.0/actor/schema.json#employee"
    },
    "team": {
      "type": "object",
      "title": "Team",
...
`https://specs.livecontracts.io/v0.1.0/scenario/schema.json#action`
...
`https://specs.livecontracts.io/v0.1.0/scenario/schema.json#state`
...
`https://specs.livecontracts.io/v0.1.0/scenario/schema.json#transition`
