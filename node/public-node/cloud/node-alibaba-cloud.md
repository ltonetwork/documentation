...
![Alibaba Cloud — LTO node — NAT Gateway — This is a paid service.](https://cdn-images-1.medium.com/max/2400/1\*2zW2s6SVcL\_kAD5S-jfKhA.png)
...
![Alibaba Cloud — LTO node — Another paid service :)](https://cdn-images-1.medium.com/max/2400/1\*nmEfeGlN\_ReZhlkWo0PfkA.png)
...
![Alibaba Cloud — LTO node — Rules!](https://cdn-images-1.medium.com/max/2400/1\*IGDikoR6vGapAw\_HX2Z2LA.png)

We do not really want rules but still, let’s click on **Create Rules Now**. Accept the proposed rules.

![Alibaba Cloud — LTO node — Security group ingress overview](https://cdn-images-1.medium.com/max/2400/1\*i5urc99VHdpSyN\_AiKGtlQ.png)
...
![Alibaba Cloud — LTO node — Finally, some container configuration](../../../.gitbook/assets/alibaba1.jpg)
...
![Alibaba Cloud — LTO node — ECI overview page](../../../.gitbook/assets/alibaba2.jpg)
...
![Alibaba Cloud — LTO node — ECI instance successfully activated](https://cdn-images-1.medium.com/max/2400/1\*mDCQchWlsQV5SaqOr\_-49Q.png)

Yes, we did it. We created our Elastic Container Instance on Alibaba Cloud! Click **Console** to see our container in action.

![Alibaba Cloud — LTO node — Looking good! blockchain downloaded, appending MicroBlocks!](https://cdn-images-1.medium.com/max/2400/1\*N-Xcl7YOptOukswRLwnX\_g.png)
