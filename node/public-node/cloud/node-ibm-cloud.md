...
![IBM Cloud — Service Catalog](https://cdn-images-1.medium.com/max/2400/1\*q5\_pl5jqbmL11H9267E3Sg.png)
...
![IBM Cloud — Kubernetes Service overview](https://cdn-images-1.medium.com/max/2400/1\*fT8iVLhrF0dHDong3FAI\_g.png)
...
![IBM Cloud — Kubernetes create an application](../../../.gitbook/assets/IBM1.jpg)
...
![IBM Cloud — Kubernetes dashboard showing your LTO Public Node successfully deployed](https://cdn-images-1.medium.com/max/2400/1\*LV21sfR5syiF\_EYTkEgppA.png)

Let’s do a final check and click on our pods name in the **Pods** section of this main screen.

![IBM Cloud — Kubernetes LTO Public Node pod configuration](../../../.gitbook/assets/IBM2.jpg)
...
![IBM Cloud — Kubernetes LTO Public Node console logging](https://cdn-images-1.medium.com/max/2400/1\*BpT97H4\_KNNOdYYeY1VuOQ.png)
